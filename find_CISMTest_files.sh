...
| xargs grep -l 'which_ho_approx=2\|which_ho_approx=2\|which_ho_approx=2' \
| xargs grep -l 'which_ho_gradient=0\|which_ho_gradient=1' \
| xargs grep -l 'which_ho_gradient_margin=1\|which_ho_gradient_margin=1\|which_ho_gradient_margin=2' \
| xargs grep -l 'which_ho_precond=2\|which_ho_precond=2' \
| xargs grep -l 'greenland_4km_2015_03_12.mcb.nofloat.4310a.beta7.nc' \
| xargs grep -l 'evolution=3\|evolution=3' \
| xargs grep -l 'which_ho_assemble_beta=0\|which_ho_assemble_beta=0' > list_CISMTest_files.sh
